...
A comprehensive Governance, Risk & Compliance (GRC) dashboard for public authorities, government agencies, and regulated organizations managing multiple EU and German regulatory frameworks.
...
1. **Download or clone the files**
   Ensure you have the following 3 files in the same directory:
   - `index.html`
   - `styles.css`
   - `main.js`

2. **Open in browser**
   Simply double-click `index.html`. No local server is required.

3. **No build process required** - Pure HTML/CSS/JS architecture.
...
Ein umfassendes Governance, Risk & Compliance (GRC) Dashboard für Behörden, öffentliche Einrichtungen und regulierte Organisationen, die mehrere EU- und deutsche Regelwerke verwalten.
...
## 📑 {#deutsch-regulatoriken} Unterstützte Regulatoriken
...
## 🚀 {#deutsch-quickstart} Schnelleinstieg
...
1. **Dateien vorbereiten**
   Stellen Sie sicher, dass `index.html`, `styles.css` und `main.js` im selben Ordner liegen.

2. **Im Browser öffnen**
   Öffnen Sie einfach die `index.html`. Kein Server notwendig.

3. **Kein Build-Prozess erforderlich** - Reine Web-Technologien.

---

## 📖 {#deutsch-bedienung} Bedienungsanleitung
...
## 🏗️ {#deutsch-architektur} Architektur
...
**Disclaimer**:
Dieses Dashboard wird als Governance-, Risk- & Compliance-Monitoring-Tool bereitgestellt. Die regulatorische Compliance erfordert professionelle GRC-Beratung und rechtliche Überprüfung.
